/*
  ...
  - Added the required column `edad` to the `Candidate` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `fecha_nac` to the `Candidate` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `sexo` to the `Candidate` table without a default value. This is not possible if the table is not empty.
